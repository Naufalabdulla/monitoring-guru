                        ...
                        @forelse($materis as $row)
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="btn-group">
                                        <a href="{{ route('guru.materi.edit', $row->id) }}"
                                            class="btn btn-sm btn-warning text-white"><i class="bi bi-pencil"></i></a>
                                        <form action="{{ route('guru.materi.destroy', $row->id) }}" method="POST"
                                            class="d-inline">
                                            @csrf @method('DELETE')
